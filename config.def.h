...
static const Bool statusmarkup =
	True; /* True means use pango markup in status message */
...
/* commands */
static const char* scratchpadcmd[] = { ".dwm/scripts/dwm-st",
	                                     scratchpadname,
	                                     NULL };
static const char* scratchemacscmd[] = { ".dwm/scripts/dwm-emacs",
	                                       scratchemacsname,
	                                       NULL };
...
void toggleemacsex(const Arg* arg)
{
